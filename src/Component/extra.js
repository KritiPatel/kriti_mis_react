                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                                ...
                                                <form class="row g-3 needs-validation" novalidate onSubmit={handleSubmit}>
                                                    <div class="col-12">
                                                        ...
                                                        {/* <div class="input-group has-validation"> */}
                                                            ...
                                                            <input type="text" name="username" class="form-control" id="yourUsername" required onChange={e => setUserName(e.target.value)}/>
                                        ...
                                        <div class="credits">
                                            Designed by <a href="https://www.moweb.com/">Moweb Technologies Private Limited</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
